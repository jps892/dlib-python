...
predictor = dlib.shape_predictor(
    '/home/jps/PycharmProjects/glassfiting/blink-detection/shape_predictor_68_face_landmarks.dat')
...
# vs = FileVideoStream('/home/jps/PycharmProjects/glassfiting/blink-detection/blink_detection_demo.mp4').start()
# fileStream = True
...
while True:
    ...
    for rect in rects:
        ...
        for (x, y) in jaw:
            cv2.rectangle(frame, (x, y), ((x + 5), (y + 5)), (0, 0, 255), -1)
